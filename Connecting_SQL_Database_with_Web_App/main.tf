...
resource "azurerm_mssql_firewall_rule" "allowmyclient" {
  ...
  start_ip_address = "client public IP address" # Replace with your client public IP address
  end_ip_address   = "client public IP address" # Replace with your client public IP address
}
